        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="Metro Admin logo" src="{{ asset('public/assets/images/logo/stack-logo.png')}}">
              <h2 class="brand-text">ABIMANYU</h2>
            </a>
          </li>
                ...
                <li class="scrollable-container media-list">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading red darken-1">9</h6>
                        <p class="notification-text font-small-3 text-muted"></p>
                        <small>
                          <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00"></time>
                        </small>
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{ asset('public/assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
